...
const selectProduct=()=>{
  ...
  return (
    <div className='flex group flex-col gap-4 w-3/12 h-80 bg-white rounded-lg z-0 hover:border-[1px] hover:border-slate-400 p-4 pb-0 hover:scale-y-110 hover:transition  hover:z-10'>
        ...
        <div className='group-hover:block'>{isStock?(<div className='font-semibold text-green-700'>In stock </div>):(<div className='font-semibold text-red-800'>Out of stock </div>)}</div>
        <div className='font-semibold text-slate-800 group-hover:block'>&#8377;{data.weightPriceData[0].price} - &#8377;{data.weightPriceData[data.weightPriceData.length-1].price}</div>
